...
int		main(int ac, char **av)
{
	...
	arrow_y();printf("ft_putnbr(-42) -> res = [");ft_putnbr(-42);printf("]\n");
	arrow_y();printf("ft_putnbr(0) -> res = [");ft_putnbr(0);printf("]\n");
	arrow_y();printf("ft_putnbr(-9223372036854775807) -> res = [");ft_putnbr(-9223372036854775807);printf("]\n");
	arrow_y();printf("ft_putnbr(9223372036854775807) -> res = [");ft_putnbr(9223372036854775807);printf("]\n");
	printf("\n");
	...
	printf("\n");
	arrow_g();printf("   isspace('\\t') -> res = [%d]\n",    isspace('\t'));
	arrow_y();printf("ft_isspace('\\t') -> res = [%d]\n", ft_isspace('\t'));
	arrow_g();printf("   isspace('\\n') -> res = [%d]\n",    isspace('\n'));
	arrow_y();printf("ft_isspace('\\n') -> res = [%d]\n", ft_isspace('\n'));
	arrow_g();printf("   isspace('\\v') -> res = [%d]\n",    isspace('\v'));
	arrow_y();printf("ft_isspace('\\v') -> res = [%d]\n", ft_isspace('\v'));
	arrow_g();printf("   isspace('\\f') -> res = [%d]\n",    isspace('\f'));
	arrow_y();printf("ft_isspace('\\f') -> res = [%d]\n", ft_isspace('\f'));
	arrow_g();printf("   isspace('\\r') -> res = [%d]\n",    isspace('\r'));
	arrow_y();printf("ft_isspace('\\r') -> res = [%d]\n", ft_isspace('\r'));
	arrow_g();printf("   isspace(' ') -> res = [%d]\n",    isspace(' '));
	arrow_y();printf("ft_isspace(' ') -> res = [%d]\n", ft_isspace(' '));
	arrow_g();printf("   isspace('*') -> res = [%d]\n",    isspace('*'));
	arrow_y();printf("ft_isspace('*') -> res = [%d]\n", ft_isspace('*'));
	printf("\n");
	arrow_g();printf("   atoi(\"-0\") -> res = [%d]\n",    atoi("-0"));
	arrow_y();printf("ft_atoi(\"-0\") -> res = [%d]\n", ft_atoi("-0"));
	arrow_g();printf("   atoi(\"  \\n\\t\\v   +42   \") -> res = [%d]\n",    atoi("  \n\t\v   +42   "));
	arrow_y();printf("ft_atoi(\"  \\n\\t\\v   +42   \") -> res = [%d]\n", ft_atoi("  \n\t\v   +42   "));
	arrow_g();printf("   atoi(\"-2147483647\") -> res = [%d]\n",    atoi("-2147483647"));
	arrow_y();printf("ft_atoi(\"-2147483647\") -> res = [%d]\n", ft_atoi("-2147483647"));
	arrow_g();printf("   atoi(\"2147483647\") -> res = [%d]\n",    atoi("2147483647"));
	arrow_y();printf("ft_atoi(\"2147483647\") -> res = [%d]\n", ft_atoi("2147483647"));
	return (0);
}
